...
@section('title', 'Novo Pool de IP')
@section('page-title', 'Novo Pool de IP')
@section('content')
    ...
    <form method="POST" action="{{ route('admin.ip-pools.store') }}">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="subnet" value="{{ old('subnet') }}" placeholder="192.168.1.0/24" required class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div>
                ...
                <input type="text" name="range_start" value="{{ old('range_start') }}" placeholder="192.168.1.10" required class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div>
                ...
                <input type="text" name="range_end" value="{{ old('range_end') }}" placeholder="192.168.1.200" required class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div>
                ...
                <input type="text" name="gateway" value="{{ old('gateway') }}" placeholder="192.168.1.1" required class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div>
                ...
                <select name="type" required class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
                    <option value="ipv4" {{ old('type')=='ipv4' ? 'selected' : '' }}>IPv4</option>
                    <option value="ipv6" {{ old('type')=='ipv6' ? 'selected' : '' }}>IPv6</option>
                </select>
                @error('type') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">DNS 1</label>
                <input type="text" name="dns1" value="{{ old('dns1') }}" placeholder="8.8.8.8" class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div>
                ...
                <input type="text" name="dns2" value="{{ old('dns2') }}" placeholder="8.8.4.4" class="w-full rounded border-gray-300 border px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <div class="flex items-end pb-2">
                <label class="flex items-center gap-2 text-sm">
                    <input type="checkbox" name="is_cgnat" value="1" {{ old('is_cgnat') ? 'checked' : '' }}>
                    Pool CGNAT
                </label>
            </div>
